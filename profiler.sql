/* $Header: profiler.sql 243755.1 2004/12/15 11:45 csierra $ */
SET DOC OFF;
/*============================================================================+
...
SET DEF '~';
PRO <font size="1"><i>(MetaLink Note:<a target="_blank" href="http://metalink.oracle.com/metalink/plsql/showdoc?db=NOT&id=238684.1">243755.1</a>)</i></font></h1>
...
SELECT '<tr>'||CHR(10)||
       ...
       '<td class="OraTableCellCenter">'||TO_CHAR(ROUND(run_total_time/1000000000,2),'FM9999999999990.00')||'</td>'||CHR(10)||
...
SELECT '<tr>'||CHR(10)||
       ...
       '</td>'||CHR(10)||
       '<td class="OraTableCellCenter">'||TO_CHAR(ROUND(u.total_time/1000000000,2),'FM9999999999990.00')||'</td>'||CHR(10)||
...
SELECT '<tr>'||CHR(10)||
       ...
       '<td class="OraTableCellCenter">'||TO_CHAR(ROUND(d.total_time/1000000000,2),'FM9999999999990.00')||'</td>'||CHR(10)||
       '<td class="OraTableCellCenter">'||TO_CHAR(d.total_occur)||'</td>'||CHR(10)||
       '<td class="OraTableCellCenter">'||TO_CHAR(ROUND(d.min_time/1000000000,2),'FM9999999999990.00')||'</td>'||CHR(10)||
       '<td class="OraTableCellCenter">'||TO_CHAR(ROUND(d.max_time/1000000000,2),'FM9999999999990.00')||'</td>'||CHR(10)||
  ...
  FOR c1 IN c1_units LOOP
    IF c1.unit_type <> 'ANONYMOUS BLOCK' THEN
      ...
      FOR c2 IN c2_source(c1.unit_owner, c1.unit_name, c1.unit_type, c1.spare1, c1.spare2) LOOP
        ...
        DBMS_OUTPUT.PUT_LINE('<td class="OraTableCellCenter">'||TO_CHAR(ROUND(l_total_time/1000000000,2),'FM9999999999990.00')||'</td>');
